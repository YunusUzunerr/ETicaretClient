...
const routes: Routes = [
   
  {
    ...
    [
      {path:"",component:DashboardComponent},//Anasayfa olacak componmentlerde loadchildren uygulanmaz.
  ...
  { path:"",component:HomeComponent},//Anasafya calısmalarında direkt componenti veriyoruz. Pathi boş olan componentlerde.
